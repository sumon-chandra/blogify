        ...
        <?php if ($blogs) { ?>
            <div class=" grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <?php foreach ($blogs as $blog) : ?>
                    <div class="p-4 space-y-4 rounded-md bg-white text-gray-800 shadow-md h-60 flex flex-col justify-between">
                        <div>
                        ...
                        <div class="text-right mt-3">
                            ...
                            <?php foreach (explode(",", $blog["tags"]) as $tag) : ?>
                                <?php if ($tag) : ?>
                                    <span class="inline-block text-gray-500 px-2 py-1 text-xs font-semibold rounded-md mr-2 cursor-pointer">#<?= $tag ?></span>
                                <?php endif ?>
                            <?php endforeach ?>
                            <a href="#" class="w-full text-gray-800 font-semibold">View Details</a>
                        </div>
                    </div>
                <?php endforeach ?>
            </div>
